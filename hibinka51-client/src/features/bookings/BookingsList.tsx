...
export const BookingsList: React.FC = () => {
    ...
    const [showCancelled, setShowCancelled] = useState(() => {
        return localStorage.getItem('showCancelledBookings') === 'true';
    });
    ...
    useEffect(() => {
        localStorage.setItem('showCancelledBookings', String(showCancelled));
        dispatch(fetchBookingsList({skip: 0, limit: 100, includeCancelled: showCancelled}));
    ...
    return (
        <Box sx={{maxWidth: 900, mx: "auto", p: {xs: 1, md: 3}}}>
            ...
            <CreateBookingModal
                ...
                onSuccess={() => dispatch(fetchBookingsList({
                    skip: 0,
                    limit: 100,
