    ...
    const handleFormTrips = async () => {
        ...
        try {
            ...
            await confirmBookingToTrip(editData.id, {
                ...
                status: "CONFIRMED",
                has_trailer: editData.has_trailer,
                            ...
                            <Card variant="outlined">
                                <CardContent>
                                    <Grid container spacing={2} alignItems="center">
                                        ...
                                        {/* Галочка прицепа теперь здесь! */}
                                        <Grid size={{xs: 12, md: 3}}>
                                            <FormControlLabel
                                                control={
                                                    <Checkbox
                                                        checked={Boolean(editData.has_trailer)}
                                                        onChange={(e) =>
                                                            setEditData({...editData, has_trailer: e.target.checked})
                                                        }
                                                        disabled={isCancelled}
                                                    />
                                                }
                                ...
                                {isNew && (
                                    <Box sx={{mt: 2, borderTop: "1px dashed grey", pt: 2}}>
                                        <FormControlLabel
                                            ...
                                            label="Учесть прицеп при диспетчеризации"
